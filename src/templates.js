    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; font-family: Arial, sans-serif;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Roboto', sans-serif; font-size: 36px; font-weight: bold; color: #000; z-index: 10; transform-origin: left top;">Edge</div>
      ...
      },
      {
        ...
        content: `
          <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 40px 20px; box-sizing: border-box; font-family: Arial, sans-serif;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="contents-logo" data-object-id="contents-logo" data-deletable="true" style="font-family: 'Roboto', sans-serif; font-size: 24px; font-weight: bold; margin-bottom: 40px; transform: rotate(-5deg);">Edge</div>
        ...
        content: `
          <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 20px; box-sizing: border-box; font-family: 'Roboto', sans-serif;">
            ...
            <div class="interview-text">
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">Edge: How would you describe your design philosophy?</div>
              ...
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">Edge: What inspired your latest collection?</div>
    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #000; position: relative; overflow: hidden; font-family: 'Courier New', monospace;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 20px; left: 20px; font-size: 40px; font-weight: bold; color: #fff; transform-origin: left top;">CHAOS</div>
      ...
      },
      {
        ...
        content: `
          <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 20px; box-sizing: border-box; font-family: 'Courier New', monospace;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="contents-logo" data-object-id="contents-logo" data-deletable="true" style="font-size: 24px; font-weight: bold; margin-bottom: 20px; transform: skew(-15deg);">CHAOS</div>
    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #f5f5f5; position: relative; overflow: hidden; font-family: 'Times New Roman', serif;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Playfair Display', serif; font-size: 24px; color: #000;">ABODE</div>
      ...
      },
      {
        ...
        content: `
          <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 40px; box-sizing: border-box; font-family: 'Times New Roman', serif;">
            ...
            <div class="interview-text">
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">Abode: How would you describe your design philosophy?</div>
              ...
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">Abode: What inspired your latest collection?</div>
            ...
            <div class="interview-text">
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-3" data-object-id="interview-question-3" data-deletable="true">Abode: How do you see the future of interior design?</div>
              ...
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-4" data-object-id="interview-question-4" data-deletable="true">Abode: Any advice for people looking to refresh their living spaces?</div>
    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #000; position: relative; overflow: hidden; font-family: 'Helvetica Neue', Arial, sans-serif;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Roboto', sans-serif; font-size: 48px; font-weight: 900; color: #fff; letter-spacing: -2px; transform: skew(-5deg);">TREND</div>
        ...
        content: `
          <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 20px; box-sizing: border-box; font-family: 'Helvetica Neue', Arial, sans-serif;">
            ...
            <div class="interview-text" style="font-family: 'Roboto', sans-serif; font-size: 14px;">
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">TREND: How would you describe your sound?</div>
              ...
              <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">TREND: What inspires your unique style?</div>
    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #f8f8f8; position: relative; overflow: hidden; font-family: 'Georgia', serif;">
            ...
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Cormorant Garamond', serif; font-size: 24px; font-weight: 300; color: #333; letter-spacing: 4px;">CALM</div>
    ...
    templates: [
      {
        ...
        content: `
          <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #000; position: relative; overflow: hidden; font-family: 'Arial', sans-serif;">
            ...
            <img src="/api/placeholder/375/812" alt="Cover image" id="coverImage" data-upload-target="true" style="width: 100%; height: 100%; object-fit: cover; opacity: 0.8;">
            <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Montserrat', sans-serif; font-size: 48px; font-weight: 700; color: #fff; letter-spacing: -2px; transform: skew(-5deg);">POP</div>
      ...
      content: `
        <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 20px; box-sizing: border-box; font-family: 'Arial', sans-serif;">
          ...
          <div class="interview-text" style="font-family: 'Roboto', sans-serif; font-size: 16px;">
            <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">POP: How would you describe your AI-driven design process?</div>
            ...
            <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">POP: What inspired your latest collection?</div>
  ...
  templates: [
    {
      ...
      content: `
        <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; font-family: 'Helvetica Neue', Arial, sans-serif;">
          ...
          <img src="/api/placeholder/375/812" alt="Cover image" id="coverImage" data-upload-target="true" style="width: 100%; height: 100%; object-fit: cover;">
          <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 20px; left: 20px; font-family: 'Space Mono', monospace; font-size: 24px; font-weight: 700; color: #fff; background-color: #000; padding: 5px 10px; transform-origin: left top;">LENS</div>
      ...
      content: `
        <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #fff; position: relative; overflow: hidden; padding: 20px; box-sizing: border-box; font-family: 'Helvetica Neue', Arial, sans-serif;">
          ...
          <div class="interview-text" style="font-family: 'Helvetica Neue', Arial, sans-serif; font-size: 14px; line-height: 1.6;">
            <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">LENS: Your work often blurs the line between photography and abstract art. How do you approach this intersection?</div>
            ...
            <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">LENS: Can you tell us about your latest project, "Quantum Visions"?</div>
  ...
  templates: [
    {
      ...
      content: `
        <div id="magazine-cover" style="width: 375px; height: 812px; margin: 0 auto; background-color: #000; position: relative; overflow: hidden; font-family: 'Arial', sans-serif;">
          ...
          <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 20px; left: 20px; right: 20px; font-family: 'Dela Gothic One', cursive; font-size: 48px; line-height: 0.9; color: #00ffff; z-index: 4; transform: skew(-5deg);">REBEL</div>
    ...
    },
    {
      ...
      content: `
        ...
        <div class="interview-text" style="font-family: 'Roboto Mono', monospace; font-size: 14px; line-height: 1.6; margin-left: 20px;">
          <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">REBEL: Your work blurs the line between human creativity and AI. How do you define your role as an artist?</div>
          ...
          <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">REBEL: Can you tell us about your latest project, "Neural Dreamscapes"?</div>
  ...
  templates: [
    {
      ...
      content: `
        ...
        <div class="logo editable deletable" contenteditable="true" data-text-id="cover-logo" data-object-id="cover-logo" data-deletable="true" style="position: absolute; top: 40px; left: 40px; font-family: 'Playfair Display', serif; font-size: 48px; font-weight: 700; color: #FF6B6B; letter-spacing: 2px;">PATTERN</div>
    ...
    },
    {
      ...
      <div id="magazine-page" style="width: 375px; min-height: 812px; margin: 0 auto; background-color: #f5f3e9; position: relative; overflow: hidden; padding: 40px 20px; box-sizing: border-box; font-family: 'Arial', sans-serif;">
        ...
        <div class="interview-text" style="font-family: 'Work Sans', sans-serif; font-size: 16px; line-height: 1.6;">
          <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-1" data-object-id="interview-question-1" data-deletable="true">PATTERN: How would you describe your illustration style?</div>
          ...
          <div class="question editable deletable" contenteditable="true" data-text-id="interview-question-2" data-object-id="interview-question-2" data-deletable="true">PATTERN: What inspires your work?</div>
